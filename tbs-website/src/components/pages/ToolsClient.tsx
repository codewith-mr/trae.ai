      ...
      <div className="container mx-auto px-4 py-8">
        {toolCategories.map((category) => {
          const categoryTools = tools.filter(tool => (
            (selectedCategory === 'All' || selectedCategory === category.name) && tool.category === category.name
          ));
